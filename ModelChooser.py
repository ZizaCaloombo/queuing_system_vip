...
def choose_model(stream_num, avg_times, lambdas, mu, query_num, test_num, comp_accur, img_tracing=True):
...
if __name__ == '__main__':
    ...
    choose_model(stream_num, avg_times, lambdas, mu, query_num, test_num, comp_accur, img_tracing)
